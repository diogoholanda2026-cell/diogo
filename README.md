...
Jogo de construção no estilo **SimCity BuildIt**, em 3D, feito para celular (testado para o Poco X7) e que também roda no computador. A obra central do jogo é a **Composição Total da Arcologia de Held**, com todas as estruturas da foto em `arte/originais/composicao-total-arcologia-de-held.png`, construídas no padrão visual da foto (luz quente de exposição, janelas acesas, céu azul-marinho com aurora) num **mundo aberto**, com praia, mar, campos e morros em volta, onde o jogador constrói a **cidade** que tem a Arcologia como centro. Cada estrutura segue a arquitetura da foto de referência (arena em grelha com torres, colinas de terraços verdes, anel de varandas brancas, rede de bandas com vidraçaria espelhada, torre em vaso com jardim na cobertura, cúpula geodésica), com a paleta natural da foto. Ela começa como pasto degradado cercado de mata e cresce etapa por etapa, com canteiro, andaimes, grua e operários, até ter cada componente da foto no lugar.
...
- **Dez bairros de lotes** de 4 x 4 (956 lotes, o triplo da primeira cidade) com ruas, calçadas, postes, árvores de rua, pedestres e carros. O **Bairro Sul** (133 lotes) abre de graça; os outros se compram quando o capítulo chega, cada vez mais longe e mais caros: Leste (25 mil, capítulo 2), Norte (60 mil) e Sudeste (90 mil) no 3, Nordeste (140 mil) e Leste Alto (200 mil) no 4, Enseada e Serra (240 mil) no 5, Sul Novo (320 mil) e Norte Novo (400 mil) no 6. Os bairros são planos e ficam prontos para crescer; depois do capítulo 6 a cidade continua. Cada tipo de prédio pode ter até 270 unidades.
...
- **Cidade:** prédios no mesmo padrão da foto (lajes creme, faixas de vidro escuro com as salas acesas à noite, canteiros verdes na borda dos terraços, coberturas verdes), fundidos por bairro e material depois de prontos. Pedestres andam em volta de cada lote construído e carros circulam pelas ruas dos bairros abertos. O zoom máximo vai até 150 unidades, para ver a cidade inteira. Com a Arcologia completa, 152 prédios da cidade no nível máximo e o aeroporto, a vista aberta fica em 320 chamadas de desenho e 605 mil triângulos (o dono liberou até o triplo do volume).
...
- **Mata em cachos** com vento e três níveis de detalhe por célula; **até 840 pessoas** nas passarelas, praças e terraços e **420 nas calçadas da cidade**, com figura simples de longe, e **até 120 carros** nas ruas dos bairros (o triplo da versão anterior; menos nas qualidades mais leves); manadas maiores de elefantes, girafas e rinocerontes e gorilas de dorso prateado que andam de verdade; um bando de 42 aves; até 480 operários nas obras.
...
fonte/
  ...
  data/                      planta traçada da foto, itens, obras e etapas, história, rótulos, cidade (bairros, lotes e tipos)
