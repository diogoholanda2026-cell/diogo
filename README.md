...
- **Configurações** em seções: vídeo, som e toque, ciclo de dia e noite (Acelerado, Hora do celular ou Sempre dia), ritmo, salvamento e acessibilidade (**Tamanho da interface**, **Reduzir movimento** e **Alto contraste**).
