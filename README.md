...
- **Serviços:** estação de água e reuso, usina solar e saneamento verde dão 4 mil de capacidade cada (os moradores novos precisam de água a partir do 3º nível e de energia e saneamento a partir do 4º); posto de saúde, escola do bairro, segurança, estação de VLT e hospital dão bem-estar.
