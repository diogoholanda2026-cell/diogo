...
- **Aprovar:** o balão sai, o carimbo APROVADO cai e bate no mesmo instante em que o andaime desmonta; depois vêm a recompensa da etapa (150% do custo, com aceleradores), as estrelas de experiência e, na última etapa de um projeto, uma volta de câmera com barras de cinema. Um modal só abre depois da festa, sem painel aberto e um de cada vez.
