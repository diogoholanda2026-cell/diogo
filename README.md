...
- **Bairros de lotes** de 4 x 4 com ruas, calçadas, postes e árvores de rua. O **Bairro Sul** (133 lotes) abre de graça; o **Leste** (88 lotes) custa 25 mil a partir do capítulo 2 e o **Norte** (133 lotes) custa 60 mil a partir do capítulo 3. Os bairros são planos, sem mata nem campos, e ficam prontos para crescer.
...
- **Serviços:** estação de água e reuso, usina solar e saneamento verde dão 4 mil de capacidade cada (os moradores novos precisam de água a partir do 3º nível e de energia e saneamento a partir do 4º); posto de saúde, escola do bairro e segurança dão bem-estar.
- **Lazer:** praça e parque com lago dão bem-estar (os quatro primeiros de cada tipo contam inteiros, os seguintes pela metade), e o bem-estar decide a renda de cada morador por hora.
...
- **Cidade:** prédios no mesmo padrão da foto (lajes creme, faixas de vidro escuro com as salas acesas à noite, canteiros verdes na borda dos terraços, coberturas verdes), fundidos por bairro e material depois de prontos. Com a Arcologia completa e 60 prédios da cidade no nível máximo, a vista aberta fica em 199 chamadas de desenho e 451 mil triângulos.
