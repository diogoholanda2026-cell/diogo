...
const CACHE = 'held-2.0.0-20260925020532';
const ARQUIVOS = ['./', './index.html', './jogo.20260925020532.js', './manifest.webmanifest', './foto.webp', './icones/icone-192.png', './icones/icone-512.png'];
