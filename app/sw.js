...
const CACHE = 'held-2.0.0-20260924232110';
const ARQUIVOS = ['./', './index.html', './jogo.20260924232110.js', './manifest.webmanifest', './foto.webp', './icones/icone-192.png', './icones/icone-512.png'];
