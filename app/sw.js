...
const CACHE = 'held-2.0.0-20260925200006';
const FONTES = ['latin-600', 'latin-800', 'latin-ext-600', 'latin-ext-800'].map((f) => `./fontes/baloo-2-${f}-normal.woff2`);
const ARQUIVOS = ['./', './index.html', './jogo.20260925200006.js', './manifest.webmanifest', './foto.webp', './icones/icone-192.png', './icones/icone-512.png', ...FONTES];
