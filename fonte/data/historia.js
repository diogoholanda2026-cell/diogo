...
export const TUTORIAL = [
  ...
  { id: 'coletar', quem: 'tome', fala: 'Quando o balão aparecer, arraste o dedo por cima dos balões para coletar tudo de uma vez.', alvo: 'balao:uusina1',
    feito: (J) => J.S.stats.coletas >= 3 },
  ...
  { id: 'meta', quem: 'iris', fala: 'A Meta em foco mostra o próximo passo até a apresentação ao Conselho. Siga por ela.', alvo: 'meta',
...
export const DICAS = {
  ...
  obraComecou: ['tome', 'A obra começou. O canteiro trabalha mesmo com o jogo fechado. Volte quando o balão verde aparecer.'],
  ...
  deposito: ['tome', 'O Depósito de Trocas vende matéria-prima com estoque que renova a cada 4 horas. E compra sobras.'],
