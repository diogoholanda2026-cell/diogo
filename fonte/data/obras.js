...
export const PROJETOS = [
  ...
  { id: 'lago', nome: 'Lago Central', cap: 1, icone: 'lago', etapas: [
    ...
    E('e3', 'Estação natural de água', 'Ilhas flutuantes filtrantes, deque e casa de bombas: água limpa para toda a arcologia.', 15, 5000, { deque: 3, painel: 2, bloco: 3 }, { servico: { agua: 5000, saneamento: 2750 }, cap: 2 }),
  ] },
  { id: 'sede', nome: 'Sede Administrativa da Holding Guarda-Chuva', cap: 1, icone: 'sede', faixa: 'sede', etapas: [
    ...
    E('e3', 'Anel de vidro solar', 'Dois pavimentos de vidro fotovoltaico: a fachada gera energia.', 20, 5000, { painel: 6, premoldado: 4, perfil: 4 }, { nivel: 3, servico: { energia: 3000 }, cap: 2 }),
  ...
  { id: 'praca', nome: 'Praça Central', cap: 2, icone: 'praca', etapas: [
    ...
    E('e3', 'Palmeiras, bancos e luzes', 'Sombra, lugar para sentar e luz para a noite.', 20, 5000, { muda: 5, deque: 2, luminaria: 2 }, { bem: 8, modo: 'crescer', cap: 3 }),
  ] },
  ...
  ...(PASSARELAS.frente2 ? [{ id: 'pas_frente2', nome: PASSARELAS.frente2.nome || 'Fita da Frente', cap: 2, icone: 'passarela', requer: ['pas_anel.e1', 'praca.e1'], etapas: [
  ...
  { id: 'biblioteca', nome: 'Biblioteca Central', cap: 3, icone: 'biblioteca', etapas: [
    ...
    E('e5', 'Dossel de vidro', 'A grande cobertura quadrada: vidro solar sobre grelha de madeira.', 45, 15500, { painel: 5, solar: 3, trelica: 3 }, { bem: 10, servico: { energia: 2500 } }),
  ] },
  { id: 'crd', nome: 'Centro de Recursos Digitais', cap: 3, icone: 'crd', requer: ['biblioteca.e1'], etapas: [
    ...
    E('e3', 'Vidro e computadores', 'Fechamento de vidro e as estações de trabalho acesas.', 35, 12000, { painel: 5, computador: 2 }, { bem: 5 }),
  ] },
  ...
  { id: 'gramadoUni', nome: 'Gramado do Campus Universitário', cap: 3, icone: 'campo', requer: ['uni.2'], etapas: [
    E('e1', 'Gramado e campo', 'O gramado central do campus com árvores ao redor.', 12, 3500, { grama: 5, muda: 3 }, { bem: 3, modo: 'crescer', servico: { saneamento: 1500 } }),
  ] },
  ...
  // o Caracol desce da Fita da Frente em espiral e sobe até o terraço do Anel
  ...(PASSARELAS.caracol ? [{ id: 'pas_caracol', nome: PASSARELAS.caracol.nome || 'Caracol do Anel', cap: 3, icone: 'passarela', requer: ['pas_frente2.e1', 'anel.3'], etapas: [
    E('e1', 'Rampa em espiral', 'Uma rampa suave em caracol, sem degraus, do chão da mata ao terraço do Anel.', 12, 5000, { deque: 3, perfil: 3, guarda: 2 }, { bem: 2 }),
  ] }] : []),
  ...
  { id: 'acelerador', nome: 'Acelerador de Partículas Subterrâneo & Centro de Física Avançada', cap: 4, icone: 'acelerador', etapas: [
    ...
    E('e3', 'Detectores', 'Detectores em camadas, racks de computação e luz azul.', 45, 45000, { sensor: 4, computador: 3, kitlab: 3 }, { bem: 3 }),
    E('e4', 'Centro de Física Avançada', 'Pavilhão curvo de vidro na borda do poço. Por baixo, uma central geotérmica.', 30, 31000, { duplo: 4, painel: 4, grama: 4 }, { bem: 3, servico: { energia: 2000 } }),
  ] },
  { id: 'anfiteatro', nome: 'Anfiteatro da Vila', cap: 4, icone: 'anfiteatro', etapas: [
    E('e1', 'Escavação e arquibancadas', 'Degraus de concreto no declive. Por baixo, uma bacia que retém e trata a água da chuva.', 20, 17000, { bloco: 5, concreto: 4 }, { servico: { agua: 1500, saneamento: 3000 } }),
    E('e2', 'Palco e iluminação', 'Palco de madeira, fundo curvo e luminárias.', 20, 17000, { deque: 4, luminaria: 4, perfil: 2 }, { bem: 6 }),
  ] },
  { id: 'pas_vila', nome: 'Passarela da Vila', cap: 4, icone: 'passarela', requer: ['anfiteatro.e1'], etapas: [
    E('e1', 'Passarela elevada', 'Da Biblioteca até a Vila Estudantil, por cima da mata.', 15, 9000, { perfil: 4, deque: 3, guarda: 3 }, { bem: 2 }),
  ] },
  ...
  { id: 'santuarioInt', nome: 'Santuário: mata e fauna', cap: 5, icone: 'santuario', requer: ['santuario.1'], etapas: [
    ...
    E('e2', 'Fauna resgatada', 'Elefantes e rinocerontes vindos de zoológicos fechados.', 40, 35500, { racao: 5, kitvet: 2 }, { bem: 4 }),
  ] },
  { id: 'savana', nome: 'Habitats Expandidos e Centro de Reabilitação', cap: 5, icone: 'savana', etapas: [
    ...
    E('e4', 'Girafas e rinocerontes', 'O habitat se completa.', 45, 38500, { racao: 5, kitvet: 2 }, { bem: 4, modo: 'surgir' }),
  ] },
  { id: 'bioma', nome: 'Bioma Aquático de Conservação', cap: 5, icone: 'bioma', etapas: [
    ...
    E('e4', 'Aquário vivo', 'Água, baleia, arraias e cardumes em recuperação.', 60, 55000, { acrilico: 5, sensor: 2, racao: 3 }, { bem: 6, requer: ['lago.e3'] }),
  ] },
  { id: 'gorilas', nome: 'Recinto dos Gorilas', cap: 5, icone: 'gorilas', etapas: [
    ...
    E('e4', 'Família de gorilas', 'Cinco gorilas resgatados chegam juntos.', 45, 41500, { racao: 5, kitvet: 2 }, { bem: 4, modo: 'surgir' }),
  ] },
...
export const MODULOS = {
  ...
  santuario: { nome: 'Santuário de Animais e Centro de Conservação', sub: 'Clínicas, pesquisa e moradia de pesquisadores', cap: 5, pop: 320, max: 4 },
};
