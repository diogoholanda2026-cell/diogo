...
export const PROJETOS = [
  ...
  { id: 'gramadoUni', nome: 'Gramado do Campus Universitário', cap: 3, icone: 'campo', requer: ['uni.3'], etapas: [
  ...
  ...(PASSARELAS.caracol ? [{ id: 'pas_caracol', nome: PASSARELAS.caracol.nome || 'Caracol do Anel', cap: 3, icone: 'passarela', requer: ['anel.3'], etapas: [
