...
const D = {
  ...
  porto(c) { sombra(c); c.beginPath(); c.moveTo(6, 70); for (let x = 6; x <= 90; x += 12) c.quadraticCurveTo(x + 6, 62, x + 12, 70); c.lineTo(90, 90); c.lineTo(6, 90); c.closePath(); c.fillStyle = lin(c, 0, 62, 0, 90, [[0, '#5cc6ff'], [1, '#1e78c8']]); c.fill(); contorno(c, 1.6);
    c.strokeStyle = '#2a3242'; c.lineWidth = 7; c.lineCap = 'round'; c.beginPath(); c.moveTo(48, 20); c.lineTo(48, 64); c.stroke(); c.beginPath(); c.moveTo(34, 30); c.lineTo(62, 30); c.stroke(); c.beginPath(); c.arc(48, 46, 20, 0.25 * Math.PI, 0.75 * Math.PI); c.stroke();
    c.strokeStyle = '#ffd21a'; c.lineWidth = 3.4; c.beginPath(); c.moveTo(48, 20); c.lineTo(48, 64); c.stroke(); c.beginPath(); c.moveTo(34, 30); c.lineTo(62, 30); c.stroke(); c.beginPath(); c.arc(48, 46, 20, 0.25 * Math.PI, 0.75 * Math.PI); c.stroke();
    c.beginPath(); c.arc(48, 14, 6, 0, 7); c.fillStyle = '#ffd21a'; c.fill(); contorno(c, 1.6); c.lineCap = 'butt'; },
