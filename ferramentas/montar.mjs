...
const unico = html.replace('<script type="module" src="__JOGO__"></script>', () => `<script>window.__FOTO__='${foto64}'</script><script type="module">` + js.replace(/<\/script/g, '<\\/script') + '</script>')
